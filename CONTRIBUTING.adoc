...
* You can monitor for the new version jar to reflect in link:https://repo1.maven.org/maven2/com/salesforce/hydra/hydra/[Maven Central]. It usually takes less than 30 minutes.
