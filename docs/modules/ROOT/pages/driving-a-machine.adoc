...
| `readTransitionAndNotifyListeners(fromStateClass, fromState, event)` | Computes the move and fires listeners *without mutating* in-memory state. See xref:async-orchestration.adoc[Async Orchestrators].
